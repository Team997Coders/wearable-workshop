...
# Tutorial: https:
# learn.adafruit.com/color-touch-pendant-necklace/introduction
# Two neopixel rings connected on pin 1 will cycle through gradient colors

#include "Adafruit_FreeTouch.h"
# include "FastLED.h"
#include "Adafruit_NeoPixel.h"

const int CAPTOUCH_PIN = 0;  #capacitive touch pin
const int NEOPIXEL_PIN = 1; #neopixel ring pin
...
void setup() {
  ...
  if (! qt_1.begin())
   ...
   //FastLED.addLeds<WS2812, COLOR_ORDER>(NEOPIXEL_PIN, COLOR_ORDER, leds, NUM_LEDS);  #Set up neopixels with FastLED
   Adafruit_NeoPixel.addLeds();
   Adafruit_NeoPixel.setBrightness(BRIGHTNESS); #set global brightness
   Adafruit_NeoPixel.setMaxPowerInVoltsAndMilliamps(3,350);  #Constrain FastLED's power usage
}
...
void Gradient()
{
  ...
  Adafruit_NeoPixel.delay(SPEEDO);
}
